...
import (
	...
	demov1alpha1 "github.com/agrajm/memcached-operator/pkg/apis/demo/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &demov1alpha1.Memcached{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &demov1alpha1.Memcached{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMemcached) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	memcached := &demov1alpha1.Memcached{}
	...
	if *found.Spec.Replicas != size {
		...
		reqLogger.Info("BOOOOM ---> Updating the right size for replicas of the memcached deployment", "Deployment.Namespace", found.Namespace, "Deployment.Name", found.Name)
...
func (r *ReconcileMemcached) deploymentForMemcached(m *demov1alpha1.Memcached) *appsv1.Deployment {
